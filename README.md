...
### Note
Makefile is for packaging and only works on Linux, just ignore it if you're not expirenced. For packaging `make clean` to remove all not needed files to run the Extension.
